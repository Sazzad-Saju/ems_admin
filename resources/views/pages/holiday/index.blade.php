...
{{--                                        <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="addToGoogle">--}}
...
@push('js')
    ...
    <script>
        ...
        function setHolidayEvents($date) {
            ...
            let holidays = @json($holidays);
            let googleEvents = @json($googleEvens);
            ...
            let googleEventPerDay = googleEvents.filter(function (x) {
                return x.start.date === date
            })
            console.log(googleEventPerDay)
            ...
            googleEventPerDay.forEach(function (x) {
                text = `<div class="alert alert-default-light holiEvent" role="alert"> <div class="row"><div class="col-2"><div class="holiIconGoogleGreen"></div></div><div class="col-10"><h5>${x.summary}</h5><hr><p>${x.description ? x.description : " No description here "}</p></div></div></div>`
        ...
        $(document).ready(function () {
            ...
            googleEvents.forEach(function (x) {
                let color = '#006a4e';
                let start = x.start.date;
                let end = x.end.date;
